...
namespace Selfix.Infrastructure.Telegram.Widgets.Avatars.Creation.AskToLoadImages;

internal sealed class AvatarCreationAskToLoadImagesWidget : IWidget<WidgetContext>
{
    private readonly ITelegramBotClient _client;

    public AvatarCreationAskToLoadImagesWidget(ITelegramBotClient client)
    {
        _client = client;
    }
    ...
    public IO<Unit> Show(WidgetContext context, CancellationToken cancellationToken)
    {
        return
            ...
            from _1 in _client.SendMessage(context.Profile.Id,
                "Имя аватара успешно установлено, теперь загрузите 10 фотографий",
                replyMarkup: markup,
